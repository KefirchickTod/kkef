...
@section('content')
    @php /** @var $item \App\Models\Kk\Article **/ @endphp
    <div class="row">
        <div class="col-md-12">
            <form method="POST" action="{{route('kk.article.update', $item->id)}}">
                @csrf
                @method('PATCH')
                @if($errors->any())
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input type="text" class="form-control" value="{{old('title', $item->title)}}" required name="title" id="title">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <select class="form-control" name="category_id" id="category_id">
                                            @foreach($categoryList as $category)
                                                <option value="{{$category->id}}" @if($category->id == old('category_id',$item->category_id)) selected @endif  >{{$category->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea class="textAreaEditor form-control" name="short_text"
                                                  id="short_text">{{$item->short_text}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div>
                                        <textarea class="textAreaEditor form-control" name="full_text"
                                                  id="full_text">{{$item->full_text}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="{{old('public', $item->public)}}" id="public">
                            ...
                            <div class="tab-pane fade" id="nav-contact" role="tabpanel"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8 col-sm-8">
                                        <input type="text" name="slug" id="slug" value="{{old('slug', $item->slug)}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
