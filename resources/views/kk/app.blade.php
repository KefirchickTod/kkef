...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/yoh5mog5p175c8wypoyjes4r78ebge58tswgzbytt92cop6k/tinymce/5/tinymce.min.js"
    ...
    <script>
        tinymce.init({
            ...
            plugins: [
                ...
                "codesample code table charmap hr pagebreak nonbreaking",
            ...
            contextmenu: "cut copy paste | link image inserttable | cell row column deletetable | eeinlinks eewidgets | removeformat",
        });
    </script>
